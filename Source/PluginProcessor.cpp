...
//==============================================================================
const String JucesynthAudioProcessor::getName() const
{
...
const String JucesynthAudioProcessor::getProgramName (int index)
{
    return {};
}

void JucesynthAudioProcessor::changeProgramName (int index, const String& newName)
{
}
...
void JucesynthAudioProcessor::processBlock (AudioBuffer<float>& buffer, MidiBuffer& midiMessages)
{
...
AudioProcessorEditor* JucesynthAudioProcessor::createEditor()
{
    return new JucesynthAudioProcessorEditor (*this);
}

//==============================================================================
void JucesynthAudioProcessor::getStateInformation (MemoryBlock& destData)
{
